    ...
    <>
      ...
      <main className=" flex flex-col justify-center items-center my-auto p-4">
        <div className="flex flex-col justify-center items-center">
          ...
          <Image src={randomImage} alt="Logo" width={160} height={160} className="mb-8" />
          ...
          <p className="text-center text-gray-500 text-lg md:text-xl lg:text-2xl mb-8">Estamos trabajando para mejorar la experiencia de usuario. ¡Mantente al tanto!</p>
